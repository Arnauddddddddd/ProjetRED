...
func (engine *EngineStruct) initMonster() { // On initialise tout les monstres
	...
	engine.monster = append(engine.monster, monsterStruct{"golem", 750, 750, 170, 0, true, rl.LoadTexture("../texture/monster/donjon2.2.png"), rl.NewRectangle(0, 326, 32, 40), rl.NewRectangle(931, 670, 32, 40), 0, 2, 0, 848, 12, 2000,  6,"dungeon", true})
	engine.monster = append(engine.monster, monsterStruct{"samurai", 800, 800, 200, 0, true, rl.LoadTexture("../texture/monster/Samurai.png"), rl.NewRectangle(0, 50, 64, 50), rl.NewRectangle(507, 607, 64, 50), 0, 7, 0, 50, 12, 2700,  6,"dungeon", false})
	engine.monster = append(engine.monster, monsterStruct{"knight", 900, 800, 250, 0, true, rl.LoadTexture("../texture/monster/DarkKnight.png"), rl.NewRectangle(0, 50, 64, 50), rl.NewRectangle(335, 510, 64, 50), 0, 9, 9, 3, 10, 2700,  6,"dungeon", false})
